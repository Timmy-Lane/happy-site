const questions = [
  ...
  {
    question:
      "Zoom-встреча, у тебя случайно включен микрофон, а ты ХОЧЕШЬ ПРИСПУСТИТЬ КЛАПАН! План спасения?",
    options: [
      "Начинаю жестко орать, делая вид что чихаю",
      "Быстро выключаю микрофон и делаю вид, что ничего не было",
      "Говорю: 'Извините, это была презентация новой формы Кайдзена!'",
      "Сказать - 'Простите, мне Тима на живот надавил'",
    ],
    scores: [7, 4, 7, 10],
  },
  {
  ...
  },
  {
    ...
    options: [
      "Паникую, но незаметно, затем импровизирую презентацию пританцовывая",
      "Честно говорю о проблеме и говорю 'Нужно посоветоваться с супругом!'",
      "Быстро перехожу на телефон и адаптирую материал",
      "Отменяю встречу, ссылаясь на технические шоколадки",
    ],
    scores: [7, 10, 8, 2],
  },
  {
  ...
  {
    question: "Что надо делать с Тимой?",
    options: ["Любить", "Облизывать", "Пиздить"],
    scores: [10, 6, 1],
  },
];
